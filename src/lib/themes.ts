...
export const THEMES: Theme[] = [
  ...
  { id: "redline", name: "Redline", blurb: "Near-black and warning red.",
...
export const DEFAULT_THEME_ID = "night-shift";
...
export function applyTheme(id: string): void {
  ...
  if (valid === DEFAULT_THEME_ID) delete document.documentElement.dataset.theme;
