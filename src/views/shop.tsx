  ...
  return (
    <div>
      ...
      <Card style={{textAlign:"center",padding:"3rem 1.5rem"}}>
        <p style={{fontSize:16,fontWeight:500,margin:"0 0 6px",color:"#f0f0f0"}}>Coming soon</p>
        <p style={{fontSize:13,color:"#888",margin:0}}>The shop portal is still in development.</p>
      </Card>
    </div>
  );
};
