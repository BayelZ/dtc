  ...
  return (
    <div style={{minHeight:"100vh",background:"#0f0f0f",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem 1rem"}}>
      <div style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{background:"#1a1a1a",border:`0.5px solid ${error?"#5a2d2d":"#2e2e2e"}`,borderRadius:10,padding:"1.5rem",animation:shake?"shake 0.4s ease":"none"}}>
          <h2 style={{fontSize:18,fontWeight:500,margin:"0 0 6px",color:"#f0f0f0"}}>Beta access</h2>
          <p style={{fontSize:13,color:"#888",margin:"0 0 24px",lineHeight:1.6}}>DTC is currently invite-only for Houston-area shops and techs.</p>
        ...
        <p style={{textAlign:"center",fontSize:12,color:"#555",marginTop:20}}>Houston beta · Limited spots available</p>
      </div>
    </div>
  );
};
