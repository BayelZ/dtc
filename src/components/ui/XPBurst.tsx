...
export const XPBurst:React.FC<{amount:number;onDone:()=>void}> = ({amount,onDone}) => {
  ...
  return <div aria-hidden style={{position:"fixed",top:"50%",left:"50%",transform:"translate(-50%,-50%)",zIndex:999,pointerEvents:"none",textAlign:"center"}}><div style={{fontSize:52,fontWeight:700,color:"var(--accent)",animation:"xpPop 1.8s ease forwards"}}>+{amount} XP</div></div>;
};
